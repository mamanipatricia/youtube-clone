export const MENU_RELATED_VIDEOS = [
  {
    id: 1,
    label: "Add to queue",
    icon: "QUEUE",
...
export const MENU_PLAYLIST_ITEM = [
  {
    id: 1,
    label: "Add to queue",
    icon: "QUEUE",
...
export const MENU_SEARCH_RESULT = [
  {
    id: 1,
    label: "Add to queue",
    icon: "QUEUE",
